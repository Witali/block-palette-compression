...
(function (global) {
  ...
  const DCT_PROFILE_FRAGMENT_SHADERS = Object.freeze({
    "0.75": "src/shaders/cube-webgl2-dctbs2-0_75bpp.frag.glsl?v=bpdh-split-1",
    "1": "src/shaders/cube-webgl2-dctbs2-1bpp.frag.glsl?v=bpdh-split-1",
    "1.5": "src/shaders/cube-webgl2-dctbs2-1_5bpp.frag.glsl?v=bpdh-split-1",
    "2": "src/shaders/cube-webgl2-dctbs2-2bpp.frag.glsl?v=bpdh-split-1",
    "3": "src/shaders/cube-webgl2-dctbs2-3bpp.frag.glsl?v=bpdh-split-1",
    "4.5": "src/shaders/cube-webgl2-dctbs2-4_5bpp.frag.glsl?v=bpdh-split-1",
    "6": "src/shaders/cube-webgl2-dctbs2-6bpp.frag.glsl?v=bpdh-split-1",
  });
