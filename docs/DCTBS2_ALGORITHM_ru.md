...
Для 32-, 40- и 48-байтных записей 6, 7,5 и 9 bpp сохранён grouped-вариант. В
низких режимах skip применяется к Y, а Cb/Cr остаются grouped; в высоких
split-luma режимах skip доступен всем трём компонентам.
